...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    firstName: Attribute.String;
    lastName: Attribute.String;
    food_preferences: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
    ...
    comments: Attribute.Relation<
      ...
      'api::comment.comment'
    >;
    favorite_dishes: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::favorite-dish.favorite-dish'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiDishDish extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.String & Attribute.Required;
    ingredients: Attribute.Component<'common.ingredients', true>;
    ...
    difficulty: Attribute.Enumeration<
      ['Facile', 'Moyen', 'Difficile', 'Azy laisse tomber mon reuf']
    >;
    recipe: Attribute.RichText & Attribute.Required;
    favorite_dishes: Attribute.Relation<
      'api::dish.dish',
      'oneToMany',
      'api::favorite-dish.favorite-dish'
...
export interface ApiFavoriteDishFavoriteDish extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::favorite-dish.favorite-dish': ApiFavoriteDishFavoriteDish;
